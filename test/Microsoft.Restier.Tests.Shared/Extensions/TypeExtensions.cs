...
namespace Microsoft.Restier.Tests.Shared.Extensions
{
    ...
    internal static partial class TypeExtensions
    {
        ...
        /// <summary>
        /// Tries to find a qualified method on a type.
        /// </summary>
        /// <param name="type">the type.</param>
        /// <param name="methodName">The method name.</param>
        /// <returns>A <see cref="MethodInfo" /> instance in case the method is found, null otherwise.</returns>
        ...
        /// <summary>
        /// Gets a qualified method on a type.
        /// </summary>
        /// <param name="type">the type.</param>
        /// <param name="methodName">The method name.</param>
        /// <returns>A <see cref="MethodInfo" /> instance in case the method is found, null otherwise.</returns>
        ...
        /// <summary>
        /// Tries to get the element type for an enumerable.
        /// </summary>
        /// <param name="type">The type.</param>
