// <copyright file="ConventionBasedOperationFilterTests.cs" company="Microsoft Corporation">
...
namespace Microsoft.Restier.Core.Tests
{
    ...
    public class ConventionBasedOperationFilterTests : IClassFixture<ServiceProviderFixture>
    {
        ...
        public ConventionBasedOperationFilterTests(ServiceProviderFixture serviceProviderFixture)
        {
        ...
        {
            var api = new ExecuteApi(this.serviceProvider);
        ...
        {
            var api = new EmptyApi(this.serviceProvider);
            var testClass = new ConventionBasedOperationFilter(typeof(EmptyApi));
            var context = new OperationContext(
                api,
                s => new object(),
