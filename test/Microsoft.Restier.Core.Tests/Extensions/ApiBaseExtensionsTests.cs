// <copyright file="ApiBaseExtensionsTests.cs" company="Microsoft Corporation">
...
namespace Microsoft.Restier.Core.Tests
{
    ...
    public class ApiBaseExtensionsTests : IClassFixture<ServiceProviderFixture>
    {
        ...
        /// </summary>
        /// <param name="serviceProviderFixture">The fixture that provides the IServiceProvider implementation.</param>
        public ApiBaseExtensionsTests(ServiceProviderFixture serviceProviderFixture)
        {
        ...
        {
            var api = new TestApi(this.serviceProvider);
        ...
        {
            Action act = () => new TestApi(this.serviceProvider).HasProperty(value);
        ...
        {
            Action act = () => new TestApi(this.serviceProvider).GetProperty<string>(value);
            act.Should().Throw<ArgumentException>();
        }
        ...
        {
            Action act = () => new TestApi(this.serviceProvider).GetProperty(value);
            act.Should().Throw<ArgumentException>();
        }
        ...
        {
            Action act = () => new TestApi(this.serviceProvider).SetProperty(value, new object());
            act.Should().Throw<ArgumentException>();
        }
        ...
        {
            Action act = () => new TestApi(this.serviceProvider).RemoveProperty(value);
            act.Should().Throw<ArgumentException>();
        }
        ...
        [Fact]
        public async Task CanCallGetModelAsync()
        {
            var api = new TestApi(this.serviceProvider);
            var cancellationToken = CancellationToken.None;
            var result = await api.GetModelAsync(cancellationToken);
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task CannotCallGetModelAsyncWithNullApi()
        {
            Func<Task> act = () => default(ApiBase).GetModelAsync(CancellationToken.None);
        ...
        public void CanCallGetQueryableSourceWithApiBaseAndStringAndArrayOfObject()
        {
            ...
            this.serviceProviderFixture.ModelMapper.Setup(x => x.TryGetRelevantType(It.IsAny<ModelContext>(), name, out expectedType)).Returns(true);
        ...
        public void CannotCallGetQueryableSourceWithApiBaseAndStringAndArrayOfObjectWithInvalidName(string value)
        {
            ...
            {
                case null:
                    Action act = () => new TestApi(this.serviceProvider).GetQueryableSource(value, new[] { new object(), new object(), new object() });
                    act.Should().Throw<ArgumentNullException>();
                    break;
                default:
                    act = () => new TestApi(this.serviceProvider).GetQueryableSource(value, new[] { new object(), new object(), new object() });
        ...
        {
            var api = new TestApi(this.serviceProvider);
            var namespaceName = "Microsoft.Restier.Core.Tests";
            var name = "Tests";
            Type expectedType = typeof(Test);

            this.serviceProviderFixture.ModelMapper.Setup(x => x.TryGetRelevantType(It.IsAny<ModelContext>(), namespaceName, name, out expectedType)).Returns(true);
        ...
        public void CannotCallGetQueryableSourceWithApiBaseAndStringAndStringAndArrayOfObjectWithInvalidNamespaceName(string value)
        {
            ...
            {
                case null:
                    Action act = () => new TestApi(this.serviceProvider).GetQueryableSource(value, "TestValue1716986786", new[] { new object(), new object(), new object() });
                    act.Should().Throw<ArgumentNullException>();
                    break;
                default:
                    act = () => new TestApi(this.serviceProvider).GetQueryableSource(value, "TestValue1716986786", new[] { new object(), new object(), new object() });
                    act.Should().Throw<NotSupportedException>();
                    break;
            }
        }
        ...
        public void CannotCallGetQueryableSourceWithApiBaseAndStringAndStringAndArrayOfObjectWithInvalidName(string value)
        {
            ...
            {
                case null:
                    Action act = () => new TestApi(this.serviceProvider).GetQueryableSource("TestValue1228629775", value, new[] { new object(), new object(), new object() }); act.Should().Throw<ArgumentNullException>();
                    break;
                default:
                    act = () => new TestApi(this.serviceProvider).GetQueryableSource("TestValue1228629775", value, new[] { new object(), new object(), new object() }); act.Should().Throw<NotSupportedException>();
                    break;
            }
        }
        ...
        public void CannotCallGetQueryableSourceWithTElementAndApiBaseAndStringAndArrayOfObjectWithInvalidName(string value)
        {
            ...
            {
                case null:
                    Action act = () => new TestApi(this.serviceProvider).GetQueryableSource<Test>(value, new[] { new object(), new object(), new object() }); act.Should().Throw<ArgumentNullException>();
                    break;
                default:
                    act = () => new TestApi(this.serviceProvider).GetQueryableSource<Test>(value, new[] { new object(), new object(), new object() }); act.Should().Throw<NotSupportedException>();
                    break;
            }
        }
        ...
        public void CannotCallGetQueryableSourceWithTElementAndApiBaseAndStringAndStringAndArrayOfObjectWithInvalidNamespaceName(string value)
        {
            ...
            {
                case null:
                    Action act = () => new TestApi(this.serviceProvider).GetQueryableSource<Test>(value, "TestValue1716986786", new[] { new object(), new object(), new object() }); act.Should().Throw<ArgumentNullException>();
                    break;
                default:
                    act = () => new TestApi(this.serviceProvider).GetQueryableSource<Test>(value, "TestValue1716986786", new[] { new object(), new object(), new object() }); act.Should().Throw<NotSupportedException>();
                    break;
            }
        }
        ...
        public async Task CanCallQueryAsync()
        {
            ...
            this.serviceProviderFixture.QueryExecutor
        ...
        {
            Func<Task> act = () => new TestApi(this.serviceProvider).QueryAsync(default(QueryRequest), CancellationToken.None);
            await act.Should().ThrowAsync<ArgumentNullException>();
        }
