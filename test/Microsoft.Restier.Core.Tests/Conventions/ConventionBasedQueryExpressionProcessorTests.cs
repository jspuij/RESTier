// <copyright file="ConventionBasedQueryExpressionProcessorTests.cs" company="Microsoft Corporation">
...
namespace Microsoft.Restier.Core.Tests
{
    ...
    public class ConventionBasedQueryExpressionProcessorTests : IClassFixture<ServiceProviderFixture>
    {
        ...
        public ConventionBasedQueryExpressionProcessorTests(ServiceProviderFixture serviceProviderFixture)
        {
        ...
        */
        ...
        {
            var api = new QueryFilterApi(this.serviceProvider);
            var instance = new ConventionBasedQueryExpressionProcessor(typeof(EmptyApi));
