...
namespace Microsoft.Restier.Tests.Shared.AspNet.Extensions
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        {
            // RWM: You may be compelled to think that we should track a static instance of HttpClient and that would be normal.
            // But because someone could test different APIs in the same test run, we can't.
