// <copyright file="RestierTestHelpers.cs" company="Microsoft Corporation">
...
namespace Microsoft.Restier.Tests.Shared.AspNet
{
    ...
    public static class RestierTestHelpers
    {
        ...
        public static async Task<HttpResponseMessage> ExecuteTestRequest<TApi, TDbContext>(
        ...
        /// <summary>
        /// Retrieves an <see cref="HttpConfiguration" /> instance that has been configured to execute a given Restier API, along with settings suitable for easy troubleshooting.
        /// </summary>
        /// <typeparam name="TApi">The class inheriting from <see cref="ApiBase"/> that implements the Restier API to test.</typeparam>
        /// <typeparam name="TDbContext">The class inheriting from <see cref="DbContext"/> that connects to the database used bt <typeparamref name="TApi"/>.</typeparam>
        /// <param name="routeName">The name that will be assigned to the route in the route configuration dictionary.</param>
        ...
        public static async Task<HttpConfiguration> GetTestableRestierConfiguration<TApi, TDbContext>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            DefaultQuerySettings defaultQuerySettings = null,
            TimeZoneInfo timeZoneInfo = null,
        ...
        public static async Task<HttpClient> GetTestableHttpClient<TApi, TDbContext>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
            where TApi : ApiBase
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous operation that will return an api instance.</returns>
        public static async Task<TApi> GetTestableApiInstance<TApi, TDbContext>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
            where TApi : ApiBase
            where TDbContext : DbContext => await GetTestableInjectedService<TApi, TDbContext, ApiBase>(
                routeName,
                routePrefix,
                serviceCollection).ConfigureAwait(false) as TApi;
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation that will return an api instance.</returns>
        public static async Task<TService> GetTestableInjectedService<TApi, TDbContext, TService>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
            where TApi : ApiBase
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation that will return an api instance.</returns>
        public static async Task<IServiceProvider> GetTestableInjectionContainer<TApi, TDbContext>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
             where TApi : ApiBase
        ...
        public static async Task<IEdmModel> GetTestableModelAsync<TApi, TDbContext>(
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
            where TApi : ApiBase
        ...
        public static async Task<XDocument> GetApiMetadata<TApi, TDbContext>(
            string host = WebApiConstants.Localhost,
            string routeName = WebApiConstants.RouteName,
            string routePrefix = WebApiConstants.RoutePrefix,
            Action<IServiceCollection> serviceCollection = default)
        ...
        /// <summary>
        /// Writes an OData metadata document to a file on disk.
        /// </summary>
        /// <typeparam name="TApi">The class inheriting from <see cref="ApiBase"/> that implements the Restier API to test.</typeparam>
        /// <typeparam name="TDbContext">The class inheriting from <see cref="DbContext"/> that connects to the database used bt <typeparamref name="TApi"/>.</typeparam>
        /// <param name="targetDirectory">The target directory.</param>
        /// <param name="suffix">The file suffix.</param>
        /// <param name="serviceCollection">The service collection to use to create the API that has to generate the document.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
        public static async Task WriteCurrentApiMetadata<TApi, TDbContext>(
            string targetDirectory = "",
            string suffix = "ApiMetadata",
            Action<IServiceCollection> serviceCollection = default)
            where TApi : ApiBase
            where TDbContext : DbContext
        {
            var filePath = $"{targetDirectory}{typeof(TApi).Name}-{suffix}.txt";
