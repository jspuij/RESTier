// <copyright file="ConventionBasedChangeSetItemValidatorTests.cs" company="Microsoft Corporation">
...
namespace Microsoft.Restier.Core.Tests
{
    ...
    public class ConventionBasedChangeSetItemValidatorTests : IClassFixture<ServiceProviderFixture>
    {
        ...
        public ConventionBasedChangeSetItemValidatorTests(ServiceProviderFixture serviceProviderFixture)
        {
        ...
        public async Task CanCallValidateChangeSetItemAsync()
        {
            ...
            await testClass.ValidateChangeSetItemAsync(context, this.dataModificationItem, validationResults, cancellationToken);
        ...
        public async Task ValidateChangeSetItemAsyncValidates()
        {
            ...
            var context = new SubmitContext(new EmptyApi(this.serviceProvider), new ChangeSet());
            var cancellationToken = CancellationToken.None;
            this.dataModificationItem.Resource = new ValidatableEntity()
            {
                Property = null,
                Number = -1,
            };
