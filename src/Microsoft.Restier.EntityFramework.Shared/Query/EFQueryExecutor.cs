// <copyright file="EFQueryExecutor.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    internal class EFQueryExecutor : IQueryExecutor
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return await this.Inner.ExecuteExpressionAsync<TResult>(context, queryProvider, expression, cancellationToken).ConfigureAwait(false);
        }
    }
}
