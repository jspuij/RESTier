// <copyright file="EntityFrameworkApi.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public class EntityFrameworkApi<T> : ApiBase
        where T : DbContext
    {
        /// <summary>
        ...
        /// </param>
        public EntityFrameworkApi(IServiceProvider serviceProvider)
