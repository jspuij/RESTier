// <copyright file="RestierOperationModelBuilder.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    internal class RestierOperationModelBuilder : IModelBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestierOperationModelBuilder"/> class.
        /// </summary>
        ...
        public async Task<IEdmModel> GetModelAsync(ModelContext context, CancellationToken cancellationToken)
        {
            ...
            {
                model = await this.InnerHandler.GetModelAsync(context, cancellationToken).ConfigureAwait(false) as EdmModel;
            }
        ...
        private void ScanForOperations()
        {
            ...
            foreach (var method in methods)
            {
                ...
                {
                    this.operationInfos.Add(new OperationMethodInfo
                    {
                        Method = method,
        ...
        {
            foreach (var operationMethodInfo in this.operationInfos)
            {
        ...
        private class OperationMethodInfo
        {
            ...
            public string Namespace => this.OperationAttribute.Namespace ?? this.Method.DeclaringType.Namespace;

            public string EntitySet => this.OperationAttribute.EntitySet;

            public bool IsComposable => this.OperationAttribute.IsComposable;

            public bool IsBound => this.OperationAttribute.IsBound;

            public bool HasSideEffects => this.OperationAttribute.OperationType == OperationType.Action;
        }
    }
}
