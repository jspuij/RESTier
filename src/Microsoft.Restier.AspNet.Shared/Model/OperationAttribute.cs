// <copyright file="OperationAttribute.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    public sealed class OperationAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the operation has side effects. Please use OperationType instead.
        /// </summary>
        ...
        {
            get => this.OperationType == OperationType.Action;
            set => this.OperationType = value ? OperationType.Action : OperationType.Function;
        }
