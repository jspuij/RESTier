// <copyright file="RestierModelBuilder.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    internal class RestierModelBuilder : IModelBuilder
    {
        ...
        public async Task<IEdmModel> GetModelAsync(ModelContext context, CancellationToken cancellationToken)
        {
            ...
            {
                innerModel = await this.InnerModelBuilder.GetModelAsync(context, cancellationToken).ConfigureAwait(false);
            }
