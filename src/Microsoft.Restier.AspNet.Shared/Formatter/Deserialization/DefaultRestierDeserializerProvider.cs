// <copyright file="DefaultRestierDeserializerProvider.cs" company="Microsoft Corporation">
...
#endif
{
    ...
    public class DefaultRestierDeserializerProvider : DefaultODataDeserializerProvider
    {
        ...
        public DefaultRestierDeserializerProvider(IServiceProvider rootContainer)
            : base(rootContainer) => this.enumDeserializer = new RestierEnumDeserializer();
