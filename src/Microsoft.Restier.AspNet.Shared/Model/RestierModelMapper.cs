// <copyright file="RestierModelMapper.cs" company="Microsoft Corporation">
    ...
    public class RestierModelMapper : IModelMapper
    {
        ...
        public bool TryGetRelevantType(ModelContext context, string name,  out Type relevantType)
        {
            ...
            if (element != null)
            {
                ...
                if (entityType != null)
                {
                    var annotation = this.model.GetAnnotationValue<ClrTypeAnnotation>(entityType);
                    if (annotation != null)
                    {
            ...
            return this.InnerMapper.TryGetRelevantType(context, name, out relevantType);
        }
        ...
        public bool TryGetRelevantType(ModelContext context, string namespaceName, string name, out Type relevantType)
        {
            ...
            // relevantType = null;
            return this.InnerMapper.TryGetRelevantType(context, namespaceName, name, out relevantType);
        }
    }
}
