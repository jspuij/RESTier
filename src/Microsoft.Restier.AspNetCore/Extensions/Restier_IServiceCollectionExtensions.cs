...
public static partial class Restier_IServiceCollectionExtensions
{
    ...
    /// </code>
    /// </example>
    public static IMvcBuilder AddRestier(this IServiceCollection services, Action<RestierApiBuilder> configureApisAction, Action<MvcOptions> mvcOptions)
    {
        ...
        return services.AddControllers(mvcOptions).AddOData();
    }
