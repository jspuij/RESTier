...
namespace Microsoft.Restier.Core
{
    ...
    internal delegate T ApiServiceContributor<T>(IServiceProvider serviceProvider, Func<T> next)
        where T : class;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// <returns>
        /// A <see cref="bool"/> specifying whether or not the <typeparamref name="TService"/> is registered.
        /// </returns>
        ...
        /// </returns>
        public static int HasServiceCount<TService>(this IServiceCollection services)
            where TService : class
        {
            Ensure.NotNull(services, nameof(services));
            ...
            where TImplement : class, TService
        {
            ...
            return services.AddContributorNoCheck<TService>(
                (sp, next) =>
                    {
                        if (factory != null)
                        {
